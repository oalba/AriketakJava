...
class Elecciones {
	...
	public static void main(String args[]) {
		...
		try{
            ...
            FileWriter fw = new FileWriter("/home/zubiri/AriketakJava/java2_elecciones2/src/censo.txt", true);
            fw.write(habitante.getDni() + ", " 
            	+ habitante.nombre + ", " 
            	+ habitante.apellido1 + ", " 
            	+ habitante.apellido2 + ", " 
            	+ habitante.edad + ", " 
            	+ habitante.sexo + "\n");
            fw.close(); 
            FileReader fr = new FileReader("/home/zubiri/AriketakJava/java2_elecciones2/src/censo.txt");
            fr.close();
...
*/
		...
		File archivo = new File("/home/zubiri/AriketakJava/java2_elecciones2/src/listadoPartidos.txt");
		Scanner s = null;
